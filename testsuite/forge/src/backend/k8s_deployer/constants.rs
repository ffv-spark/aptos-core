...
pub const DEFAULT_FORGE_DEPLOYER_IMAGE_TAG: &str = "1aa5895d4e02741ad3967a70ce20170bfb78ad25"; // default to the latest stable build from the main branch (2025-11-04)
